...
TPM Clothing Studio is a FiveM developer tool for previewing clothing packs, browsing drawables and textures, switching peds, and capturing catalogue-ready screenshots with clean filenames.
...
2. Ensure `screenshot-basic` before this resource.
...
Use **Screenshot** to capture the current item. Screenshots save into the resource screenshot folder with structured filenames.
